    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                form = SignupForm()
                return render(request, 'registration/signup.html', {'form': form, 'msg': 'Weak password used'})
                    ...
                    if(form.cleaned_data['new_password'] == form.cleaned_data['confirm_password']):
                        ...
                        try:
                            ...
                            return render(request, 'registration/forgot_password.html',
                                          {'form': form, 'msg': 'Weak password used'})
...
def user_trip_list(request):
    ...
    all_trips = Trip.objects.filter(participants=current_user)
